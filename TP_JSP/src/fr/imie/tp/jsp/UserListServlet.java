...
public class UserListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	PersonneDTO personneToFind = new PersonneDTO();
    	personneToFind.setId(deleteId);
    	service.deletePersonne(personneToFind);
		...
		PersonneDTO/*UserDTO*/ connectedUser = (PersonneDTO/*UserDTO*/)request.getSession().getAttribute("connectedUser");
		if ( connectedUser.getId() == personneToFind/*userToDelete*/.getId() )
		...
		request.setAttribute("users", service.findAllPersonne()/*userDTOs*/);
