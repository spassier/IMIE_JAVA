...
import fr.imie.archi.DTO.PersonneDTO; //import fr.imie.jdbc.DTO.PersonneDTO;
...
public class SecurityFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		PersonneDTO /*UserDTO*/ connectedUser = (PersonneDTO/*UserDTO*/) httpServletRequest.getSession().getAttribute("connectedUser");
		...
		PersonneDTO recentConnectedUser = (PersonneDTO) httpServletRequest.getSession().getAttribute("connectedUser");
